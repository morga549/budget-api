const CONST = {
    ...
    queries: {
        ...
        get_expenses_by_category: 'SELECT to_char(date, \'YYYY-MM-DD\'), description, amount FROM budget.expenses WHERE date >= date_trunc(\'month\', CURRENT_DATE) AND category = $1;',
